                ...
                <?php if(Route::has('login')): ?>
                    <div class="">
                        <?php if(auth()->guard()->check()): ?>
                            <a href="<?php echo e(url('/dashboard')); ?>" class="text-muted">Dashboard</a>
                        <?php else: ?>
                            <a href="<?php echo e(route('login')); ?>" class="text-muted">Log in</a>

                            <?php if(Route::has('register')): ?>
                                <a href="<?php echo e(route('register')); ?>" class="ms-4 text-muted">Register</a>
                            <?php endif; ?>
                        <?php endif; ?>
                    </div>
                <?php endif; ?>
...
<?php /**PATH C:\laragon\www\todo2\resources\views/welcome.blade.php ENDPATH**/ ?>